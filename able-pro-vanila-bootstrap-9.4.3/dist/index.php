        ...
        <div class="auth-form">
          <div class="card my-5">
            <div class="card-body">
              ...
              <form action="./pages/panel.php" method="post">
              <div class="mb-3">
                <input type="email" class="form-control" id="floatingInput" placeholder="Tu correo" />
              </div>
              <div class="mb-3">
                <input type="password" class="form-control" id="floatingInput1" placeholder="Tu Contraseña" />
              </div>
              ...
              <div class="d-flex justify-content-between align-items-end mt-4">
                ...
                <a href="register-v1.html" class="link-primary">Create una cuenta</a>
              </div>
              </form>
            </div>
          </div>
