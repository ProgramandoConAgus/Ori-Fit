...
// Mostrar encabezado de la propuesta de alimentos
echo "<h2>Propuesta de alimentos</h2>";

// Verificar si hay alimentos disponibles
if ($resultado_alimentos->num_rows > 0) {
    // Mostrar tabla de alimentos
    echo "<table id='tabla_alimentos' border='1'>
            <thead>
                <tr>
                    <th>Nombre</th>
                    <th>Calorías</th>
            ...
            <tbody>";
    // Recorrer y mostrar cada alimento en una fila
    while ($alimento = $resultado_alimentos->fetch_assoc()) {
        echo "<tr>
    ...
    echo "No se encontraron alimentos disponibles."; // Mensaje si no hay alimentos
}
...
<!-- DataTables para funcionalidad avanzada de la tabla -->
<script src="https://cdn.datatables.net/1.10.21/js/jquery.dataTables.min.js"></script>
<!-- CSS para estilo de DataTables -->
<link rel="stylesheet" href="https://cdn.datatables.net/1.10.21/css/jquery.dataTables.min.css">

<script>
// Inicializa DataTables en la tabla para paginación, ordenamiento y búsqueda
